...
@Configuration
@ConditionalOnProperty(name = "DATABASE_URL") // Only activate if DATABASE_URL env var exists
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        // Parse postgresql:// format (Render, Railway, etc.)
        ...
        // If DATABASE_URL is already in JDBC format, fall back to default
